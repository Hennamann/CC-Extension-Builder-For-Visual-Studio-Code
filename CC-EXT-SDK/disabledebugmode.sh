#!/bin/bash
/usr/libexec/PlistBuddy -c "Delete:PlayerDebugMode" ~/Library/Preferences/com.adobe.CSXS.10.plist
...
/usr/libexec/PlistBuddy -c "Delete:PlayerDebugMode" ~/Library/Preferences/com.adobe.CSXS.4.plist
